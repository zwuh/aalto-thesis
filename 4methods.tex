...
% (not centred). If at all possible, try to make the table narrow enough so
...
T-110.6130 & Systems Engineering for Data Communications
    Software & \raggedright Computer simulations, mathematical modelling,
...
If you have not yet done any (real) methodological courses (but chosen
...
methodological courses that concentrates especially to methods are
