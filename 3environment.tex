...
many Linux flavours such as Fedora, Debian, Ubuntu, and Gentoo.
...
syntax colouring options and such really helps a lot.
My personal favourite for editing \LaTeX\ is the
\emph{TeXlipse}~\cite{TeXlipse} plug in for the Eclipse IDE~\cite{Eclipse}.
...
The TeXlipse plug in allows you to edit and compile \LaTeX\ documents directly
...
The plug in also supports reference traversal so that you can locate the source
...
Emacs at least has syntax colouring and you can compile your document with a key
...
TikZ package (TikZ is a front end for the PGF graphics formatting system).
...
These show how graphs can be drawn and labelled.
...
\begin{subfigure}[b]{\textwidth}
  ...
  \caption{Examples of obstruction graphs for the Ferry Problem}
\end{subfigure}
\begin{subfigure}[b]{\textwidth}
  \input{images/general-star-graphs.tex}
  \caption{Examples of star graphs}
\end{subfigure}
