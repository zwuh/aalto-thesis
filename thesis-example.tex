...
% ------------------------------------------------------------------
\startchapright\input{1introduction.tex}

\startchapright\input{2background.tex}

\startchapright\input{3environment.tex}

\startchapright\input{4methods.tex}
 
\startchapright\input{5implementation.tex}

\startchapright\input{6evaluation.tex}
 
\startchapright\input{7discussion.tex}
 
\startchapright\input{8conclusions.tex}
